...
class Order_model extends CI_Model {
    ...
    public function create_order($order_data, $cart_items) {
        ...
        $order_insert_data = [
            ...
            'customer_document' => $order_data['customer_document'] ?? null,
            'shipping_address' => $order_data['shipping_address'],
            'shipping_number' => $order_data['shipping_number'] ?? null,
            'shipping_complement' => $order_data['shipping_complement'] ?? null,
            'shipping_neighborhood' => $order_data['shipping_neighborhood'] ?? null,
