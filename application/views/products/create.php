    ...
    <div class="max-w-4xl mx-auto">
        <div class="bg-white rounded-lg shadow-xl p-8">
            <div class="flex items-center justify-between mb-6">
                <h1 class="text-3xl font-bold text-gray-800">Criar Produto</h1>
                <a href="<?= base_url() ?>" class="text-blue-600 hover:text-blue-800 text-sm">← Voltar</a>
            </div>

            <form method="post" action="<?= base_url('products/store') ?>" class="space-y-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-2">Nome do Produto</label>
                        <input type="text" name="name" class="form-input w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent" placeholder="Digite o nome do produto" required>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="price" id="price" class="form-input w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent" placeholder="0,00" required>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div id="variations-wrapper" class="space-y-3">
                        <div class="flex gap-3">
                            <input type="text" name="variations[0][name]" placeholder="Nome da variação (ex: Tamanho M)" class="form-input flex-1 px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent" required>
                            <input type="number" name="variations[0][quantity]" placeholder="Estoque" min="0" class="form-input w-24 px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent" required>
                ...
                <div class="flex gap-4 pt-4">
                    ...
                    <a href="<?= base_url() ?>" class="flex-1 bg-gray-200 text-gray-700 px-6 py-3 rounded-lg font-semibold hover:bg-gray-300 focus:ring-4 focus:ring-gray-200 transition duration-200 text-center">
                        Cancelar
                    </a>
                </div>
            </form>
