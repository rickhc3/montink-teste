                    ...
                    <div class="p-4">
                        <?php if (empty($cart)): ?>
                            <div class="empty-cart">
                                ...
                                <a href="<?= base_url('products') ?>" class="btn btn-primary" style="border-radius: 25px; padding: 0.75rem 1.5rem; font-size: 0.95rem; font-weight: 500;">
        ...
        <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content" style="border-radius: 15px; border: none; box-shadow: 0 10px 30px rgba(0,0,0,0.2);">
                <div class="modal-header" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; border-radius: 15px 15px 0 0; border: none;">
                    <h5 class="modal-title" id="checkoutModalLabel"><i class="bi bi-credit-card me-2"></i>Finalizar Pedido</h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body" style="padding: 2rem;">
                    ...
                    <form id="checkout-form">
                        <div class="row">
                            <div class="col-lg-8">
                                <h4 class="mb-3" style="color: #2c3e50; border-bottom: 2px solid #667eea; padding-bottom: 10px;"><i class="bi bi-person me-2"></i>Dados Pessoais</h4>
                                
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        <label for="checkout_customer_name" class="form-label">Nome Completo *</label>
                                        <input type="text" class="form-control" id="checkout_customer_name" name="customer_name" required style="border-radius: 8px; border: 2px solid #e9ecef; padding: 12px 15px;">
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label for="checkout_customer_email" class="form-label">E-mail *</label>
                                        <input type="email" class="form-control" id="checkout_customer_email" name="customer_email" required style="border-radius: 8px; border: 2px solid #e9ecef; padding: 12px 15px;">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="tel" class="form-control" id="checkout_customer_phone" name="customer_phone" required style="border-radius: 8px; border: 2px solid #e9ecef; padding: 12px 15px;">
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label for="checkout_customer_cep" class="form-label">CEP *</label>
                                        <input type="text" class="form-control" id="checkout_customer_cep" name="customer_cep" required maxlength="9" placeholder="00000-000" style="border-radius: 8px; border: 2px solid #e9ecef; padding: 12px 15px;">
                                    </div>
                                </div>
                                
                                <h4 class="mb-3 mt-4" style="color: #2c3e50; border-bottom: 2px solid #667eea; padding-bottom: 10px;"><i class="bi bi-geo-alt me-2"></i>Endereço de Entrega</h4>
                                
                                <div class="row">
                                    <div class="col-md-8 mb-3">
                                        <label for="checkout_customer_address" class="form-label">Endereço *</label>
                                        <input type="text" class="form-control" id="checkout_customer_address" name="customer_address" required style="border-radius: 8px; border: 2px solid #e9ecef; padding: 12px 15px;">
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        <label for="checkout_customer_number" class="form-label">Número *</label>
                                        <input type="text" class="form-control" id="checkout_customer_number" name="customer_number" required style="border-radius: 8px; border: 2px solid #e9ecef; padding: 12px 15px;">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" class="form-control" id="checkout_customer_complement" name="customer_complement" style="border-radius: 8px; border: 2px solid #e9ecef; padding: 12px 15px;">
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        <label for="checkout_customer_neighborhood" class="form-label">Bairro *</label>
                                        <input type="text" class="form-control" id="checkout_customer_neighborhood" name="customer_neighborhood" required style="border-radius: 8px; border: 2px solid #e9ecef; padding: 12px 15px;">
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        <label for="checkout_customer_city" class="form-label">Cidade *</label>
                                        <input type="text" class="form-control" id="checkout_customer_city" name="customer_city" required style="border-radius: 8px; border: 2px solid #e9ecef; padding: 12px 15px;">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select class="form-control" id="checkout_customer_state" name="customer_state" required style="border-radius: 8px; border: 2px solid #e9ecef; padding: 12px 15px;">
                            ...
                            <div class="col-lg-4">
                                <div style="background: #f8f9fa; border-radius: 10px; padding: 20px; position: sticky; top: 20px;">
                                    <h4 class="mb-3" style="color: #2c3e50; border-bottom: 2px solid #667eea; padding-bottom: 10px;"><i class="bi bi-receipt me-2"></i>Resumo do Pedido</h4>
                                    ...
                                    <div class="d-flex justify-content-between py-2" id="checkout-discount-row" style="display: none !important;">
                                        <span>Desconto:</span>
                                    ...
                                    <div class="d-flex justify-content-between py-2 border-top pt-3 mt-2" style="font-weight: 600; font-size: 1.1em; color: #333;">
                                        <span>Total:</span>
                                        <span id="checkout-total">R$ <?= number_format($subtotal + 20.00, 2, ',', '.') ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="modal-footer" style="border: none; padding: 1rem 2rem 2rem;">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" style="border-radius: 25px; padding: 0.75rem 1.5rem;">Cancelar</button>
                    <button type="submit" form="checkout-form" class="btn" id="checkout-submit-btn" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border: none; border-radius: 25px; padding: 0.75rem 2rem; color: white; font-weight: 600;">
